<div class="fluent-menu" data-role="fluentmenu">
	<ul class="tabs-holder">
		...
		<li><a href="#tab_mailings">文章标签</a></li>
		<li><a href="#tab_folder">最近评论</a></li>
	...
	<div class="tabs-content">
			...
			<div class="tab-panel-group">
				<div class="tab-group-content">
					<button class="fluent-big-button">
						<span class="icon-mail"></span>Create<br />message
					</button>
					<div class="tab-content-segment">
						<button class="fluent-big-button dropdown-toggle">
							<span class="icon-pictures"></span> <span class="button-label">Create<br />element
							</span>
						</button>
					...
					<div class="tab-content-segment">
						<button class="fluent-big-button">
							<span class="icon-cancel"></span> <span class="button-label">Delete</span>
						</button>
					</div>
				</div>
				...
				<div class="tab-group-content">
					<div class="tab-content-segment">
						<button class="fluent-button">
							<span class="icon-reply on-left"></span>Replay
						</button>
						<button class="fluent-button">
							<span class="icon-reply-2 on-left"></span>Replay all
						</button>
						<button class="fluent-button">
							<span class="icon-cycle on-left"></span>Forward
						</button>
					</div>
					<div class="tab-content-segment">
				...
				<div class="tab-group-content">
					...
					<div class="tab-content-segment">
						<button class="fluent-button dropdown-toggle">
							<span class="icon-filter on-left"></span> <span
								class="button-label">Mail Filters</span>
						</button>
						<ul class="dropdown-menu" data-role="dropdown">
		...
		<div class="tab-panel" id="tab_mailings"></div>

		<div class="tab-panel" id="tab_folder"></div>

		<div class="tab-panel" id="tab_view"></div>
	</div>
</div>